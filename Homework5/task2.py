...
def repeats(our_str):
    """
    Расчет того, сколько раз каждый символ уже встречался в строке
    :param our_str: параметр исходной строки
    :return: новая строка, в которой показывается сколько раз каждый символ уже встречался в исходной строке
    """
    new_str = ''
    for i in our_str:
