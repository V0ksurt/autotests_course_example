...
def letter_stat(our_str):
    """
    Расчет количества вхождения каждой буквы в строку
    :param our_str: строка, происходит расчет количества каждой буквы в строку
    :return: словарь, где в качестве ключей буквы строки, а значениями являются числа,
# соответствующие количеству вхождений данной буквы в строку
    """
    letters_dict = {i: our_str.count(i) for i in our_str}   # Генератор, в котором в качестве "i" перебираем все
    # символы строки, а в качестве значения используется функция count, которая считает количество вхождений элемента
    # в строку
    return letters_dict
